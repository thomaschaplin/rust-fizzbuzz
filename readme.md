...
Fizzbuzz written in [rust](https://www.rust-lang.org/)
...
* Clone this repository `git clone git@github.com:thomaschaplin/rust-fizzbuzz.git`
* Change directory `cd rust-fizzbuzz`
